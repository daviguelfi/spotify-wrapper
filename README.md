...
[![Build Status](https://travis-ci.org/daviguelfi/spotify-wrapper.svg?branch=master)](https://travis-ci.org/daviguelfi/spotify-wrapper) [![Coverage Status](https://coveralls.io/repos/github/daviguelfi/spotify-wrapper/badge.svg?branch=master)](https://coveralls.io/github/daviguelfi/spotify-wrapper?branch=master)

A wrapper to work with the [Spotify Web API](https://developer.spotify.com/web-api/).

## Browser Support

This library relies on [Fetch API](https://fetch.spec.whatwg.org/). And this API is supported in the following browsers. I do this following this [course](https://www.udemy.com/share/101uMEBEEfdFtXQnQ=/)
...
| ![Davi Guelfi Erba](https://avatars3.githubusercontent.com/u/33698595?v=4 )|
|:---------------------:|
|  [Davi Guelfi Erba](https://github.com/daviguelfi/)   |

See also the list of [contributors](https://github.com/daviguelfi/spotify-wrapper/contributors) who participated in this project.
